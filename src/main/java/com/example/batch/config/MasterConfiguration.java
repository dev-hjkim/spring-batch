...
public class MasterConfiguration {
    ...
    private final RemotePartitioningManagerStepBuilderFactory remotePartitioningMasterStepBuilderFactory;

    public MasterConfiguration(JobBuilderFactory jobBuilderFactory,
                               RemotePartitioningManagerStepBuilderFactory remotePartitioningMasterStepBuilderFactory) {
        this.jobBuilderFactory = jobBuilderFactory;
        this.remotePartitioningMasterStepBuilderFactory = remotePartitioningMasterStepBuilderFactory;
    }
